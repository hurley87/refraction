-- Add Solana as a sponsored activation settlement rail.
-- Each Solana activation owns a dedicated Privy Solana campaign wallet
-- (privy_campaign_wallet_id + campaign_wallet_address). Existing settlement
-- lifecycle functions are rail-agnostic.
...
ALTER TABLE sponsored_activation
  ...
  CHECK (settlement_rail IN ('base', 'stellar', 'tempo', 'solana'));
