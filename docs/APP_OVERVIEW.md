...
- refreshed landing page (hero city carousel, artist CTA, city guides cover + carousel, IRL tour) -> interactive map (`Find Spots Nearby`) and **city guides** entry points
...
2. **App action:** Load visible locations for the map, merge DICE events with admin-managed manual events from Supabase for the events page (with optional city and date filters), load published guides/editorials from Supabase for the city guides hub, or load the active checkpoint configuration.
...
| Rewards catalog                          | Lists active rewards across `/rewards` and `/perks` with eligibility and expiration context; admins can pin a **featured** perk (`is_featured`) to the hero slot and the list sorts ending-soon perks toward the top. Logged-out users see a **Join IRL** CTA on reward detail.                                                                                                                                                                                                                                                        | End users                        | `live` |
...
| Events page                              | Shows public events merged from DICE plus manual events stored in Supabase and edited through admin routes; users can filter by city and date range.                                                                                                                                                                                                                                                                                                                                                                                   | End users                        | `live` |
| Cities admin + event city tagging        | Admins manage a `cities` table and assign manual events to cities; public `/api/cities` powers event-page city filters.                                                                                                                                                                                                                                                                                                                                                                                                                | Internal team                    | `live` |
...
| City guides + editorials                 | Serves published city guides and editorial pages from a Supabase-backed CMS, including guide-to-map handoff.                                                                                                                                                                                                                                                                                                                                                                                                                           | End users                        | `live` |
...
| Admin operations surfaces                | Admin routes exist for users, locations (including CSV export), checkpoints, perks, manual events, analytics, city metrics, sponsored activations, and related operations.                                                                                                                                                                                                                                                                                                                                                             | Internal team                    | `live` |
...
- Events data is hybrid: DICE API plus manual events stored in Supabase and edited through admin routes.
