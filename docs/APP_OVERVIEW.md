...
| Admin operations surfaces                | Admin routes exist for users, locations, checkpoints, perks, manual events, analytics, city metrics, sponsored activations, and related operations.                                                                                                                                                                                                                              | Internal team                    | `live` |
