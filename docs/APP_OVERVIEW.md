...
2. **App action:** Load visible locations for the map, merge DICE events with manual JSON events for the events page, load published guides/editorials from Supabase for the city guides hub, or load the active checkpoint configuration.
