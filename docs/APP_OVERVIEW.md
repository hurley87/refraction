...
- refreshed landing page (hero city carousel, artist CTA, city guides cover + carousel, IRL tour with admin-pinnable featured event) -> interactive map (`Find Spots Nearby`) and **city guides** entry points
...
| Interactive map                          | Shows visible locations and serves as the main discovery surface for check-ins; desktop/4K layout and responsive drawer UX are in active development.                                                                                                                                                                                                                                                                                                                                                                                  | End users                        | `live` |
