  ...
  return (
    <div className="bg-white rounded-none md:rounded-2xl p-4 sm:p-6 w-full h-full md:h-auto mx-auto md:max-h-[90vh] overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* Token Name */}
        <div>
          <Label htmlFor="name" className="text-sm font-inktrap text-gray-700">
            Token Name *
          </Label>
          <Input
            id="name"
        ...
        {/* Token Symbol */}
        <div>
          <Label htmlFor="symbol" className="text-sm font-inktrap text-gray-700">
            Token Symbol *
          </Label>
          <Input
            id="symbol"
        ...
        {/* Description */}
        <div>
          <Label htmlFor="description" className="text-sm font-inktrap text-gray-700">
            Description
          </Label>
          <Textarea
            id="description"
