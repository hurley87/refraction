...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full max-w-md mx-auto bg-[#131313] text-white md:max-w-full">
      {/* Mobile Layout */}
      <div className="relative min-h-[600px] w-full overflow-hidden pb-8 pt-20 md:hidden">
        <img
      ...
      <div className="hidden md:block w-full bg-[#131313] text-white">
        ...
        {/* Row 3 - Desktop Footer Image */}
        <div className="w-full md:px-[30px] md:pb-[33px]">
          <Image
            src="/homepage/irl-footer-desktop.svg"
            alt="IRL Footer"
            width={1920}
            height={200}
