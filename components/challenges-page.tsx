  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="bg-white rounded-3xl p-6">
        ...
        <button className="w-full bg-[#313131] hover:bg-gray-800 text-white py-3 px-4 rounded-full font-pleasure transition-colors duration-200 flex items-center justify-between">
