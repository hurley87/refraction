      ...
      >
        ...
        >
          <div className="flex flex-col items-center gap-4 w-full max-w-2xl">
            <div
              className="font-pleasure title2 text-[30px] tracking-[-1px] md:text-[30px] md:leading-[100px] md:tracking-[-1px] uppercase text-white text-center w-3/4"
              style={{
            ...
            <div
              className="font-pleasure title2 text-[30px] tracking-[-1px] md:text-[40px] md:leading-[100px] md:tracking-[-1px] uppercase text-white text-center w-3/4"
              style={{
                textShadow: "0 0 24px rgba(255, 255, 255, 0.54)",
              }}
            >
