...
describe('LocationSearch', () => {
  ...
  describe('Initial Rendering', () => {
    it('should render search button in collapsed state', () => {
      ...
      expect(
        screen.getByRole('button', { name: /search location/i })
      ).toBeInTheDocument();
    });

    it('should show custom placeholder', () => {
      render(
        <LocationSearch onSelect={mockOnSelect} placeholder="Find a place" />
      );
        ...
        json: async () => ({
          suggestions: [
            ...
            },
            {
              ...
              mapbox_id: 'mapbox-2',
              name: 'New Orleans',
              place_formatted: 'New Orleans, LA, USA',
            },
          ],
        }),
      } as Response);
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should close dropdown on Escape key', async () => {
      ...
      fireEvent.keyDown(screen.getByPlaceholderText('Search location'), {
        key: 'Escape',
      });
