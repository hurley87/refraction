...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Content overlay */}
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 pt-20 pb-4 gap-[33px] md:pt-0 md:pb-0">
        {/* Heading section */}
        <div className="flex flex-col gap-4 items-start text-white text-center w-[325px] max-w-full md:w-[1177px]">
          <h1
            className="font-pleasure font-black text-[40px] leading-[44px] tracking-[-3.2px] md:text-[100px] md:leading-[100px] md:tracking-[-8px] uppercase w-full"
            style={{
