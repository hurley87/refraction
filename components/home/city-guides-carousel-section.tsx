    ...
    <>
      <style>{`
        @media (min-width: 768px) {
          .city-guides-section-desktop-bg {
            width: 1728px;
            height: 1117px;
            aspect-ratio: 181/117 !important;
            background: linear-gradient(0deg, rgba(0, 0, 0, 0.35) 0%, rgba(0, 0, 0, 0.35) 100%), url('/homepage/featured-cities.jpg') lightgray -0.211px -35px / 100.024% 103.133% no-repeat !important;
          }
        }
      `}</style>
      <section
      ...
      >
        <div className="w-full h-full px-2 pt-[129px] pb-6 flex flex-col overflow-hidden md:pt-[201px] md:pb-16 md:pl-[171px] md:pr-[217px] md:max-w-[1177px] md:mr-auto">
          ...
          <div
            className="flex w-[377px] max-w-full flex-col items-stretch gap-4 pt-0 pb-4 px-6 rounded-xl overflow-hidden md:mt-[400px]"
            style={{
