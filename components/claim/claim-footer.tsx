...
export default function ClaimFooter() {
  ...
  return (
    <footer className="w-full bg-white text-[#131313]">
      <div className="mx-auto flex max-w-md flex-col gap-10 px-6 py-12">
        <div className="flex flex-col gap-4">
          <p className="text-center text-[11px] font-medium uppercase tracking-[0.44px]">
            Follow
          </p>
          ...
          <form onSubmit={handleNewsletterSubmit} className="w-full space-y-2">
            <div className="flex w-full gap-2">
              <input
                ...
                className="h-10 flex-1 rounded-full border border-[#131313]/15 bg-white px-4 text-[15px] text-[#131313] placeholder:text-[#7d7d7d] focus:outline-none focus:ring-2 focus:ring-[#131313]/20 disabled:cursor-not-allowed disabled:opacity-50"
              />
              <button
                type="submit"
                disabled={isSubmitting}
                className="flex h-10 w-10 items-center justify-center rounded-full bg-[#131313] transition-colors hover:bg-[#131313]/80 disabled:cursor-not-allowed disabled:opacity-50"
