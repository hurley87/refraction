...
/** Same geometry as `MapNav` default mark (70×39); glow matches `irlLogoVariant="dashboard"`. */
...
export function IrlLogoDashboard() {
  const rawId = useId();
...
/** Re-export path for `MapNav` default / light variants (no glow). */
export { IRL_LOGO_PATH_D };
