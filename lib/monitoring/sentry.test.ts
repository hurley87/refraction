...
describe('isPrivySolanaParsedTokenAccountNoise', () => {
  it('detects Privy SPL balance jsonParsed null parsed.info (JAVASCRIPT-NEXTJS-20)', () => {
    expect(
      isPrivySolanaParsedTokenAccountNoise(
...
describe('sentryBeforeSend', () => {
  ...
  it('returns null for Privy Solana parsed.info null noise (JAVASCRIPT-NEXTJS-20)', () => {
    const event = {
      request: { url: 'https://www.irl.energy/dashboard' },
      exception: {
        values: [
