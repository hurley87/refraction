/**
 * Reward1155 Contract ABI (legacy)
 *
 ...
 *
 * WalletCon claim + mint on Base now uses `lib/walletcon-nft.ts` (ERC-721 + USDC reward).
 */

export const REWARD1155_ADDRESS =
  '0xf2894fEd9CAa5E6422bF45D9fE1B38b06D9c46b8' as const;
...
export const REWARD1155_CONFIG = {
  ...
  metadataUri:
    'https://cyan-genuine-pheasant-886.mypinata.cloud/ipfs/bafkreifn3alhdejcnaly3uglcf2yc7pwtxbpft4xd7ucb2tua6niu4kquu',
} as const;
