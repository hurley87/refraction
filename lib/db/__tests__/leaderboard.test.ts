...
describe('Leaderboard Database Module', () => {
  ...
  describe('getLeaderboard', () => {
    ...
    it('should fall back to manual query when RPC fails', async () => {
      const playersData = [
        { id: 1, wallet_address: '0x1234', username: 'player1', email: null, total_points: 500 },
        { id: 2, wallet_address: '0x5678', username: 'player2', email: null, total_points: 300 },
      ]
    ...
    it('should calculate dense rank correctly - same points get same rank', async () => {
      const playersData = [
        { id: 1, wallet_address: '0x1234', username: 'player1', email: null, total_points: 500 },
        { id: 2, wallet_address: '0x5678', username: 'player2', email: null, total_points: 500 }, // Same points
        { id: 3, wallet_address: '0xabcd', username: 'player3', email: null, total_points: 300 },
      ]
      ...
      expect(result[1].rank).toBe(1) // Same rank - tied with player 1
      expect(result[2].rank).toBe(3) // Third place (not second, due to two players tied at 1st)
    })
    ...
    it('should throw error when fallback query fails', async () => {
      ...
      await expect(getLeaderboard()).rejects.toEqual({ message: 'Database error' })
    })
      ...
      const mockCheckins = [
        {
          ...
          locations: { name: 'Location 1', display_name: 'Display 1', latitude: 0, longitude: 0 },
        },
        {
          id: 'checkin-2',
          player_id: 1,
          ...
          locations: { name: 'Location 2', display_name: 'Display 2', latitude: 0, longitude: 0 },
        },
      ]
