...
const locationSelection =
  'id, name, address, description, latitude, longitude, place_id, points_value, type, event_url, context, coin_address, coin_symbol, coin_name, coin_image_url, creator_wallet_address, creator_username';
