    ...
    >
      ...
      >
        ...
        <Image
          ...
          width={827}
          height={969}
          className="block lg:hidden pl-6 pb-12"
        />
        <Image
        ...
        />
        <div className="flex flex-col items-center justify-center text-left px-4 sm:px-6 md:px-8 lg:px-12 sm:pt-12 md:pt-16 lg:pt-0 w-full ">
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 w-full">
            <h3 className="text-white text-base leading-relaxed max-w-xl text-left ">
      ...
      >
        <div className="flex flex-col items-start justify-end w-full lg:w-1/2 mb-8 lg:mb-0">
        ...
        <div className="flex flex-col items-end justify-end w-full lg:w-1/2">
            ...
            <div className="w-full lg:w-1/2 order-2 lg:order-1">
              ...
              <form className="flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="bg-black hover:bg-gray-800 text-white font-inktrap w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center"
                >
                  ->
                </Button>
              </form>
