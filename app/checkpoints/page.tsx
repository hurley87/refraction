...
export default async function CheckpointsPage() {
  return (
    <div className=" relative  flex-col items-center justify-center md:grid w-full  md:px-0 font-sans">
      <div className="relative  flex flex-col  bg-gradient-to-r from-orange-600 from-10% via-rose-300 via-90% to-yellow-300 to-100% p-6 text-BLACK dark:border-r justify-between">
        <div className="flex">
          <div className="flex-auto text-black text-lg pt-5"><p className="text-4xl text-center">Earn rewards for supporting culture</p></div>
      ...
      <div className="relative  flex flex-col gap-3 bg-gradient-to-r from-yellow-300 from-10% via-rose-300 via-30% to-sky-500 to-90% p-6 text-BLACK dark:border-r justify-between">
        <div className="flex">
          ...
          <div className="flex-auto text-black text-xl"><Checkpoints/></div>
          <div className="flex-none text-black "><p className="text-4xl text-center"><Image src="/images/IRL Rings.svg" width={200} height={200} alt="rings"/></p></div>
          </div>
      </div>
