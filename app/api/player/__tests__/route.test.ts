...
describe('Player API Route', () => {
  ...
  describe('POST /api/player', () => {
    ...
    it('should handle database errors gracefully', async () => {
      vi.mocked(getPlayerByWallet).mockRejectedValueOnce(new Error('Database connection failed'))
  ...
  describe('GET /api/player', () => {
    ...
    it('should handle database errors gracefully', async () => {
      vi.mocked(getPlayerByWallet).mockRejectedValueOnce(new Error('Database error'))
