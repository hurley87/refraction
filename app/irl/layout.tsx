  ...
  return (
    <div className="h-screen">
      ...
      >
        ...
        <div className="flex justify-between items-center border-2 border-black h-16">
          {/* Column 1: IRL Logo - 60% width */}
          <div className="flex-[0.6] flex justify-start border-r border-black h-full">
            <Link href="/" className="p-2 lg:px-4 h-full flex items-center">
              <Image 
        ...
        <div className="border-2 border-black">
          ...
          <div className="flex justify-between items-center h-24">
            ...
            <div className="flex-[0.3] flex flex-col justify-center h-full">
              <div className="p-2 lg:px-4 h-full flex flex-col justify-center">
                <p className="text-xs lg:text-md text-black font-inktrap uppercase mb-4">@ 2025 IRL REFRACTION ALL RIGHTS RESERVED.</p>
                <div className="flex space-x-2 lg:space-x-4">
                  <div className="flex-1 flex justify-start">
                    <Link href="/privacy" className="text-xs lg:text-md text-black hover:text-gray-600 transition-colors duration-200 font-inktrap">
                      PRIVACY POLICY
                    </Link>
                  </div>
                  <div className="flex-1 flex justify-end">
                    <Link href="/terms" className="text-xs lg:text-md text-black hover:text-gray-600 transition-colors duration-200 font-inktrap">
                      TERMS OF SERVICE
                    </Link>
                  </div>
                </div>
