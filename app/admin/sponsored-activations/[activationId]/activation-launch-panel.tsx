                    ...
                    <div className="mt-4 border-t border-neutral-100 pt-4 dark:border-neutral-800">
                      <div className="flex flex-col gap-3 sm:grid sm:grid-cols-[minmax(0,1fr)_auto] sm:gap-x-3 sm:gap-y-1.5">
                        ...
                        <p className="order-3 text-xs text-neutral-500 sm:col-start-1 sm:row-start-3">
                          Withdraws the full withdrawable balance to the address
                          above, including funds earmarked for pending activity.
                          {activation.settlement_rail === 'stellar'
                            ? ' On Stellar, withdrawable may be less than the wallet balance when other activations share the campaign wallet.'
