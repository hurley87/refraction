      ...
      <div className="min-h-screen p-4 space-y-1">
        ...
        >
          ...
          {event.descriptionTitle && (
            <h3 className="text-white w-full">{event.descriptionTitle}</h3>
          )}
            ...
            >
              <div className="flex w-full gap-4">
                <div className="flex-1 flex items-end">
                  <div className="text-white display2 font-inktrap">
                    {stat.value}
                  </div>
                </div>
                <div className="flex-1 text-right">
                  <div className="text-white title4 font-abc-monument-regular">
                    {stat.label}
                  </div>
                </div>
              </div>
    ...
    >
      ...
      <div className="flex w-full gap-4 align-text-bottom">
        ...
        <div className="flex-1 pr-2 text-right">
          <div className={`text-black ${rightSize} ${rightFont} text-bottom`}>
            {rightText}
          </div>
        </div>
      </div>
      ...
      <div className="max-w-lg mx-auto w-full">
        ...
        >
          <p className="text-white title3 items-center text-center ">
            ...
            parties, lineups, and art shaping scenes worldwide. Plug your brand
            or venue into our partner platform and reach an audience of 40,000+
        ...
        <div className="bg-[#131313] rounded-2xl p-6 mb-4">
          <p className="text-white font-grotesk text-center title3 ">
            Since 2021, Refraction has built a trusted network of 200+ cultural
            partners. IRL extends this network to your venue or brand.
          </p>
        </div>
        ...
        <div className="relative z-10 h-full flex items-center justify-center p-6 sm:p-8">
          <div className="text-center space-y-6">
            ...
            <div className="text-white title4 font-anonymous-pro max-w-2xl mx-auto">
              Joining is simple. Share a reward, we list it, push it to 40k+
              culture-first members, and send you monthly results. No Staff
              training, no hidden costs.
            </div>
