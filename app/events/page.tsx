      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="px-0 pt-4 space-y-4">
          ...
          <div className="mb-6">
            ...
            >
              {/* Next Event Title */}
              <h1 className="text-black body-small font-monument-grotesk mb-4">NEXT EVENT</h1>
              ...
              <div className="flex w-full gap-2">
                ...
                >
                    <svg
                      ...
                      aria-hidden="true"
                    >
                      <rect x="3" y="4" width="14" height="13" rx="2" className="fill-transparent" stroke="#7D7D7D"/>
                      <path d="M3 8h14" stroke="#7D7D7D" strokeLinecap="round"/>
                      <path d="M7 2v2M13 2v2" stroke="#7D7D7D" strokeLinecap="round" />
                    </svg>
                  <span className="text-black body-small uppercase font-abc-monument-regular">{nextEvent.date}</span>
                </div>
                <div 
                  style={{
                    display: 'flex',
                ...
                >
                    ...
                    >
                      <path
                        d="M10 2C7.24 2 5 4.24 5 7c0 5.25 5 11 5 11s5-5.75 5-11c0-2.76-2.24-5-5-5zm0 7.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"
                      />
                    </svg>
              ...
              >
                ...
                <div className="flex w-full gap-2">
                  ...
                  >
                    ...
                    <span className="text-black body-small uppercase font-abc-monument-regular">{event.date}</span>
                  </div>
                  <div 
                    style={{
                      display: 'flex',
                  ...
                  >
                    <span className="text-black body-small font-abc-monument-regular">MAP</span>
                    <Image
